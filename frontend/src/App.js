...
import payHome from "./Components/PaymentHomeComponent/home";
      ...
      <UserContext.Provider value={{ state, dispatch }}>
        <Router>
          ...
          <Switch>
            ...
            <Route exact path="/payHome/:price" component={payHome} />
            <Route exact path="/Success/:method/:price" component={Success} />
